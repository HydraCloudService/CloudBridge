...
namespace hydracloud\cloud\bridge\module\sign\config;
...
final class SignLayoutConfig {
    ...
    public function __construct() {
        ...
        $this->config = new Config(CloudBridge::getInstance()->getDataFolder() . "signLayouts.yml", 2, self::DEFAULT_LAYOUTS);
    }
